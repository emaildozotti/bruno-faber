...
const COPY = {
  eyebrow: 'sobre mim',
  heading: 'Eu não comecei',
  headingEm: 'pela psicologia.',
  paragraphs: [
    'Passei dois anos e meio na Engenharia da Computação. Gostava de lógica, de processos, de entender como as coisas funcionam por dentro. Mas tinha algo que as máquinas não resolviam: a sensação de que eu estava construindo uma vida que não fazia sentido pra mim.',
    'Saí da engenharia e comecei do zero. Trouxe comigo o rigor, a análise e a busca por processos que de fato funcionam. Só que agora aplicados ao que mais importa: o comportamento humano.',
    'Hoje trabalho com adultos que vivem no automático. Que sabem o que precisam fazer, mas travam. Que repetem os mesmos erros e se frustram com os mesmos resultados. Meu trabalho é ajudá-los a entender o próprio funcionamento e, a partir disso, agir diferente.',
  ],
  transition: 'Se você chegou até aqui, talvez esteja se perguntando como funciona na prática.',
