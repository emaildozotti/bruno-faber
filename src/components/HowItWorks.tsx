  ...
  steps: [
    {
      ...
      body: 'Você agenda uma conversa pelo WhatsApp. Nesse primeiro contato, eu entendo sua situação e você entende como eu trabalho. Sem compromisso, sem pressão.',
    },
    {
      title: 'Primeiras sessões',
      body: 'Juntos, nós mapeamos os padrões que estão travando a sua vida. Eu investigo o que mantém cada ciclo funcionando e construo com você um plano de ação claro.',
    },
    {
      title: 'Mudança real',
      body: 'Sessão a sessão, você começa a agir diferente. Não porque alguém mandou, mas porque você aprendeu a ler o seu próprio funcionamento. O objetivo é que, no final, você caminhe com as próprias pernas.',
    },
  ],
  note: 'Cada pessoa tem seu ritmo. Eu respeito o seu, mas não te deixo parado.',
