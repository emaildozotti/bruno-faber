...
// ════════════════════════════════════════════════════════════════════
const COPY = {
  callout: 'PSICOLOGIA BASEADA EM CIÊNCIA',
  h1: 'Você sabe o que precisa mudar.',
  h1Em: 'Mas não consegue sair do lugar.',
  subtitle: 'Terapia com foco em resultado concreto, não em conversa sem fim.',
  ctaPrimary: 'Quero agendar minha conversa',
