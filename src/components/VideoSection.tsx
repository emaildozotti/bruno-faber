...
// ════════════════════════════════════════════════════════════════════
const COPY = {
  heading: 'Antes de decidir qualquer coisa,',
  headingEm: 'me escuta por 60 segundos.',
  preText: 'Eu gravei esse vídeo porque sei que a maioria das pessoas chega aqui com uma pergunta na cabeça: será que isso funciona pra mim?',
  postText: 'Se o que você ouviu fez sentido, talvez valha a pena continuar lendo.',
}
// ════════════════════════════════════════════════════════════════════
